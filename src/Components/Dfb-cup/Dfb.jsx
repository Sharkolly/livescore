import data from '../Json/pokal.json';
import { toast } from 'react-toastify';

export default function Dfb() {
  ...
  return (
    ...
    <button onClick={() => toast.success('Clicked!!!')}>Success</button>
    <button onClick={() => toast.warn('Clicked!!!')}>Warn</button>
    <button onClick={() => toast.error('Clicked!!!')}>Fial</button>
    <button onClick={() => toast.info('Clicked!!!')}>Nevr</button>
